      ...
      <>
        ...
        >
          ...
          <div className=" w-[32vw] h-[70vh] bg-white bg-opacity-50 rounded-3xl mt-[3vh] p-12">
            <h3 className=" font-bold text-5xl">SignUp</h3>
            <div class="relative h-11 w-full min-w-[200px] mt-[15%]">
              <input
            ...
            <div className=" w-full h-[50px]  mt-[15%] flex gap-7">

              <div className=" w-[45%] hover:bg-gray-400 rounded-full hover:duration-500 flex items-center justify-center font-semibold text-[20px] ">
                Daftar
              </div>
              <Link to="/login" className="w-[45%] hover:bg-gray-400 rounded-full hover:duration-500 bg-transparent flex items-center justify-center font-semibold text-[20px] ">
